...
sorted_mean_TOA = main_df.iloc[min_deltaRMS_indices].sort_values(by=['mean_TOA'])["mean_TOA"].to_numpy()
...
plt.ylim(0, 1.2*main_df.iloc[min_deltaRMS_indices]["mean_TOA"].max())
